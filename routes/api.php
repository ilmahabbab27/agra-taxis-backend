...
Route::get('/external/fare-estimate', [EstimateController::class, 'externalCalculate']);
Route::post('/external/fare-estimate', [EstimateController::class, 'externalCalculate']);
